...
const styles = StyleSheet.create({
  ...
  studentName: { fontSize: 14, fontFamily: "Helvetica-Bold" },
  ...
  matCard: { marginTop: 14, borderRadius: 10, borderWidth: 1, borderColor: "#e2e8f0", overflow: "hidden" },
  ...
  indRow: { flexDirection: "row", alignItems: "center", paddingVertical: 6, paddingHorizontal: 10, borderTopWidth: 1, borderTopColor: "#e2e8f0" },
  indDesc: { flex: 1, fontSize: 8, color: TEXT, paddingRight: 8, lineHeight: 1.35 },
  barWrap: { width: 110, flexDirection: "row", gap: 2, marginRight: 8 },
  barSeg: { flex: 1, height: 10, borderRadius: 3 },
  scoreBadge: { width: 32, paddingVertical: 3, borderRadius: 3, fontSize: 9, fontFamily: "Helvetica-Bold", textAlign: "center", color: TEXT, backgroundColor: YELLOW },

  commentBox: { marginTop: 10, borderRadius: 10, overflow: "hidden", borderWidth: 1, borderColor: "#e2e8f0" },
  ...
  footer: { position: "absolute", left: 24, right: 24, bottom: 28, flexDirection: "row", justifyContent: "space-between" },
  scaleCol: { width: 240 },
  ...
  signCol: { width: 200 },
  signSmall: { fontSize: 9, color: MUTED },
  signTitle: { fontSize: 10, fontFamily: "Helvetica-Bold", marginTop: 2 },
  signImg: { width: 110, height: 60, marginVertical: 8, objectFit: "contain" },
  signName: { fontSize: 10, fontFamily: "Helvetica-Bold" },

  pageFooter: { position: "absolute", left: 0, right: 0, bottom: 8, fontSize: 7, color: "#94a3b8", textAlign: "center" },
});
...
export function StudentReportPdf({ data }: { data: PdfReportData }) {
  ...
  const coverSrc = data.coverBgDataUrl || coverBg;

  return (
    <Document>
      {/* COVER */}
      <Page size="A4" style={styles.page}>
        <Image src={coverSrc} style={styles.coverImg} />
      ...
      {pages.map((pageMats, pi) => {
        ...
        return (
          <Page key={pi} size="A4" style={styles.page}>
            ...
            <View style={[styles.body, isLast ? { paddingBottom: 230 } : {}]}>
              {pi === 0 && (
